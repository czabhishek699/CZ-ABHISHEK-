...
// Database setup (using MySQL as an example)
...
// Other backend setup and routes...
    ...
    if (err) {
      ...
      if (result.length === 0) {
        ...
        bcrypt.compare(password, user.password, (err, match) => {
          if (match) {
            // Authentication successful, create session/token and redirect to the dashboard
            // Set a cookie, use JWT, or implement other authentication mechanisms
...
<div class="sidebar" id="sidebar">
     <a href="https://avishekojha.com.np" target="_blank">Home</a>
        <a href="https://www.facebook.com/rbabhishek10?mibextid=b06tZ0" target="_blank">Facebook</a>
